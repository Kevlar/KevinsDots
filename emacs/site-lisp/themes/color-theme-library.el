...
(defun color-theme-kevlar ()
  ...
  (color-theme-install
   '(color-theme-kevlar
      ...
      (border-color . "#000000")
      (cursor-color . "#ffffff")
      (foreground-color . "#00e607")
      (mouse-color . "black"))
     (fringe ((t (:background "#000000"))))
     (mode-line ((t (:foreground "#000000" :background "#03fa00"))))
     (region ((t (:background "#207e34"))))
     (font-lock-builtin-face ((t (:foreground "#29fffb"))))
     (font-lock-comment-face ((t (:foreground "#ff7d38"))))
     (font-lock-function-name-face ((t (:foreground "#97ff61"))))
     (font-lock-keyword-face ((t (:foreground "#429eff"))))
     (font-lock-string-face ((t (:foreground "#ffad33"))))
     (font-lock-type-face ((t (:foreground"#e234c4"))))
     (font-lock-variable-name-face ((t (:foreground "#b86f9d"))))
     (minibuffer-prompt ((t (:foreground "#b0b0b0" :bold t))))
     (font-lock-warning-face ((t (:foreground "Red" :bold t))))
     )))
(provide 'color-theme-kevlar)
